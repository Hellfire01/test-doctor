...
class TestDoctorCLI:
    ...
    def __configure_cli(self):
        ...
        self.parser.add_argument("-dr", "--disable-auto-root", help="If given, prevents the test doctor from automatically finding a root with morethan one test / directory", action="store_true")
        ...
        self.parser.add_argument("-dg", "--disable-show-graph", help="If given, will disable the graph display windows ( compatible with the --save-graph-path argument )", action="store_true")
        ...
        self.parser.add_argument("-dc", "--disable-console", help="If given, the test doctor will not output the results in the console", action="store_true")
    ...
    def get_instructions(self, args: [str]) -> TestDoctorInstructions:
        ...
        ret = TestDoctorInstructions(
            ...
            disable_console=namespace.disable_console,
        )
        return ret
